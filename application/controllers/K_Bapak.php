...
class K_Bapak extends CI_Controller {
	...
	public function index(){
		...
		$data['menu8'] = 'class="active"';//kaum pria
		...
		// Data Jadwal Kaum Bapak
		$data['ibadah'] = $this->Model_ibadah->readIbadah('kaum bapak');
		// tampilan
		...
		if($this->Model_ibadah->insertIbadah()){
			...
			redirect(base_url('K_Bapak/index'));
		} else {
