...
class K_Muda extends CI_Controller {
	...
	public function index(){
		...
		$data['menu10'] = 'class="active"';//kaum pemuda
		...
		// Data Ibadah kaum Muda
		$data['ibadah'] = $this->Model_ibadah->readIbadah('kaum muda');
		// tampilan
		...
		if($this->Model_ibadah->insertIbadah()){
			...
			redirect(base_url('K_Muda/index'));
		} else {
